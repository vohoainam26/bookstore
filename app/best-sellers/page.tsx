...
export const metadata = {
  title: "Sách bán chạy | Trang Sách",
  description: "Những tựa sách được độc giả yêu thích và lựa chọn nhiều nhất.",
};
...
export default async function BestSellersPage({
  ...
  // Lấy dữ liệu với sortBy bestseller (dựa trên reviews_count theo cấu trúc hiện tại)
      ...
      <div className="bg-white border-b border-gray-200 py-10 px-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span className="text-gray-900 font-medium">Sách bán chạy</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-4" style={{ fontFamily: "var(--font-display)" }}>
            Sách bán chạy
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
            Những tựa sách được độc giả yêu thích và lựa chọn nhiều nhất.
          </p>
        </div>
      </div>
          ...
          <>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-12">
                {currentPage > 1 && (
                  <Link
                    href={`/best-sellers?page=${currentPage - 1}`}
