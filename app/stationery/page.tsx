...
export const metadata = {
  title: "Văn phòng phẩm | Trang Sách",
  description: "Các sản phẩm văn phòng phẩm, bút, sổ tay, và dụng cụ học tập.",
};
      ...
      <div className="bg-white border-b border-gray-200 py-10 px-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span className="text-gray-900 font-medium">Văn phòng phẩm</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-4" style={{ fontFamily: "var(--font-display)" }}>
            Văn phòng phẩm
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
            Các sản phẩm văn phòng phẩm, bút viết, sổ tay, và dụng cụ học tập cao cấp.
          </p>
        </div>
      </div>
          ...
          <>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-12">
                {currentPage > 1 && (
                  <Link
                    href={`/stationery?page=${currentPage - 1}`}
