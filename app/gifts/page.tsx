...
export const metadata = {
  title: "Quà tặng | Trang Sách",
  description: "Khám phá những món quà và sản phẩm lưu niệm dành cho người thân, bạn bè.",
};
      ...
      <div className="bg-white border-b border-gray-200 py-10 px-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span className="text-gray-900 font-medium">Quà tặng</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-4" style={{ fontFamily: "var(--font-display)" }}>
            Quà tặng
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
            Khám phá những món quà và sản phẩm lưu niệm dành cho người thân, bạn bè.
          </p>
        </div>
      </div>
